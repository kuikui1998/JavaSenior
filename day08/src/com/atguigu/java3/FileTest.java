...
public class FileTest {
    ...
    public void test1(){
        ...
        File file1 = new File("D:\\Java\\workspace_idea\\JavaSenior\\day08\\he.txt");

        System.out.println(file);
        System.out.println(file1);

        //构造器2
        File file2 = new File("D:\\Java\\workspace_idea","JavaSenior");
...
 public File[] listFiles() ：获取指定目录下的所有文件或者文件目录的File数组
    ...
    @Test
    public void test3(){
        File file = new File("D:\\Java\\workspace_idea\\JavaSenior");
