 ...
 * OutputStream         FileOutputStream (writer(byte[] cbuf,0,len)         BufferedOutputStream(writer(byte[] cbuf,0,len)
 * Reader               FileReader(read(char[] cbuf)                        BufferedReader(read(char[] cbuf / readLine())
 * Writer               FileWriter(writer(char[] cbuf,0,len)                BufferedWriter(writer(char[] cbuf,0,len) /flush()
 *
 * @auther kuikui
 * @create 2020-06-04 16:12
 */
public class FileReaderWriterTest {

    public static void main(String[] args) {
        File file  = new File("hello.txt");//相较于当千工程
...
//                System.out.println(str);
    ...
    @Test
    public void testFileReadrerFileWriter()  {
        FileReader fr = null;
        FileWriter fw = null;
        try {
