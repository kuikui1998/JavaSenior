 ...
 *  *              |---ArrayList：作为List接口的主要的实现类，线程不安全的，效率高；底层使用Object[] elementData 存储
 ...
 *     }
 *
 *      4. Vector的源码分析：jdk7和jdk8中通过Vecotr()构造器创建对象时，底层都创建了长度为10的数组
...
插：addAll(int index, Collection eles)
长度：size()
遍历：①Iterator迭代器方式
      ②增强for循环
      ③普通循环
    ...
    public void test2(){
        ...
        //List subList(int fromIndex, int toIndex):返回从fromIndex到toIndex 位置的左闭右开区间的子集合
